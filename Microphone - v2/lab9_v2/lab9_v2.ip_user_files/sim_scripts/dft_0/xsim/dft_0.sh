...
#
# Generated by Vivado on Wed Apr 14 00:53:47 -0400 2021
...
# Script info
echo -e "dft_0.sh - Script generated by export_simulation (Vivado v2016.3 (64-bit)-id)\n"
...
elaborate()
{
  $xv_path/bin/xelab --relax --debug typical --mt auto -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot dft_0 xil_defaultlib.dft_0 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  $xv_path/bin/xsim dft_0 -key {Behavioral:sim_1:Functional:dft_0} -tclbatch cmd.tcl -log simulate.log
}
